    ...
    ((a.jstree = {
      ...
      (a.jstree.core.prototype = {
                        ...
                        if (
                          ...
                          if (
                            ...
                            if (this.settings.core.expand_selected_onload) {
                              ...
                              for (
                                b = a.vakata.array_unique(b), c = 0, d = b.length;
                                d > c;
                                c++
                              )
        ...
        get_node: function (b, c) {
          (b && b.id && (b = b.id),
            b instanceof django.jQuery && b.length && b[0].id && (b = b[0].id));
          var d;
          try {
        ...
        _parse_model_from_html: function (c, d, e) {
          ...
          ((k = c.children("a").children(".jstree-themeicon")),
            k.length &&
              (i.icon = k.hasClass("jstree-themeicon-hidden") ? !1 : k.attr("rel")),
        ...
        redraw_node: function (b, c, d, e) {
          ...
          (f.state.hidden && (n += " jstree-hidden"),
            ...
            f.state.loaded && !v
              ? (n += " jstree-leaf")
              : ((n +=
                  f.state.opened && f.state.loaded ? " jstree-open" : " jstree-closed"),
        ...
        open_all: function (b, c, d) {
          if ((b || (b = a.jstree.root), (b = this.get_node(b)), !b)) return !1;
          var e =
              b.id === a.jstree.root ? this.get_container_ul() : this.get_node(b, !0),
            f,
            g,
            h;
          if (!e.length) {
        ...
        get_json: function (b, c, d) {
          ...
          var e = {
              ...
              state: {},
              data:
                c && c.no_data ? !1 : a.extend(!0, a.isArray(b.data) ? [] : {}, b.data),
            },
            f,
            g;
          if (
            (c && c.flat ? (e.parent = b.parent) : (e.children = []), c && c.no_state)
          )
            delete e.state;
          else
              ...
              g && g.functions && (g.functions[b] === !1 || g.functions[b] === !0)
                ...
                : h === !1 ||
                  ...
                  ? ((this._data.core.last_error = {
                      ...
                      id: "core_03",
                      reason:
                        "User config for core.check_callback prevents function: " + b,
                      data: JSON.stringify({
                        chk: b,
                        pos: e,
                        obj: c && c.id ? c.id : !1,
        ...
        move_node: function (c, d, e, f, g, h, i) {
          ...
          if (c.parent === n.id) {
            ...
            for (
              r = c.children_d.concat(), r.push(c.id), s = 0, t = c.parents.length;
              t > s;
              s++
            ) {
              for (
        ...
        copy_node: function (c, d, e, f, g, h, i) {
          ...
          if (
            ((p = s ? s.get_json(c, { no_id: !0, no_data: !0, no_state: !0 }) : c), !p)
          )
            return !1;
          if (
            (p.id === !0 && delete p.id,
              ...
              b && b.id !== a.jstree.root
                ? ((f = this.get_node(b, !0)),
                  void (
                    ...
                    f.length &&
                      f.children(".jstree-anchor").removeClass("jstree-checked"),
                ...
                return d
                  ? (c.items.push(d),
                    ...
                    (e +=
                      ...
                      "</a>"),
                    d.submenu &&
                      ((g = a.vakata.context._parse(d.submenu, !0)), g && (e += g)),
                    (e += "</li>"),
                    void (
                      d.separator_after &&
                      ((e +=
            ...
            if (
              ...
              if (!c.is_drag) {
                if (
                  ...
                  return;
                (c.helper &&
                  (c.helper.appendTo(i.body), (c.helper_w = c.helper.outerWidth())),
                  (c.is_drag = !0),
                    ...
                    return (
                      this.scrollHeight > this.offsetHeight &&
                        (e.top + d.height() - b.pageY <
                          a.vakata.dnd.settings.scroll_proximity && (c.scroll_t = 1),
                        b.pageY - e.top < a.vakata.dnd.settings.scroll_proximity &&
                          (c.scroll_t = -1)),
                      this.scrollWidth > this.offsetWidth &&
                        (e.left + d.width() - b.pageX <
                          a.vakata.dnd.settings.scroll_proximity && (c.scroll_l = 1),
      ...
      (a.jstree.plugins.massload = function (b, c) {
        ((this.init = function (a, b) {
          ...
          (this._load_node = function (b, d) {
            ...
            return e
              ? ((f = this[
                  "string" == typeof e ? "_append_html_data" : "_append_json_data"
                ](
                  b,
                  "string" == typeof e
        ...
        ((this.check = function (b, c, e, f, g) {
          ...
          switch (
              ...
              return (
                ...
                m ||
                  (this._data.core.last_error = {
                    ...
                    id: "unique_01",
                    reason:
                      "Child with name " + h + " already exists. Preventing: " + b,
                    data: JSON.stringify({
                      chk: b,
                      pos: f,
                      obj: c && c.id ? c.id : !1,
            ...
            case "move_node":
              return (
                (m =
                  (c.parent === e.id && (!g || !g.is_multi)) || -1 === a.inArray(h, i)),
                m ||
                  (this._data.core.last_error = {
                    error: "check",
                    plugin: "unique",
